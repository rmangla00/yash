...
public class EmployeeControllerTest {
	...
	public void shouldReturnListOfEmployeesInJSONFormat() throws Exception {
		List<Employee> employees = Arrays.asList(new Employee(101, "employeeName1", 1000.0),
				new Employee(102, "employeeName2", 2000.0));
	...
	public void shouldReturnEmployeeInJSONFormatWhenIdIsGiven() throws Exception {
		Employee employee = new Employee(101, "employeeName", 1000.0);
	...
	@Test
	public void shouldUpdateEmployeeInJSONFormatWhenIdIsGiven() throws Exception {
		Employee employee = new Employee();
		employee.setId(201);
		employee.setName("employeeName");
		employee.setSalary(1000.0);
		...
		RequestBuilder requestBuilder = put("/employees/201").accept(MediaType.APPLICATION_JSON)
				.contentType(MediaType.APPLICATION_JSON).content(asJsonString(employee));
	...
	@Test
	public void shouldDeleteEmployeeWhenIdIsGiven() throws Exception {
